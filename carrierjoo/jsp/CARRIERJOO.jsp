...
<%
	CarrierjooEvent  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String rlaneCds			= "";
	String crrCds			= "";
	Logger log = Logger.getLogger("com.clt.apps.CarrierJoo.CarrierJoo");
...
<html>
<head>
<title>Carrier Joo Management</title>
