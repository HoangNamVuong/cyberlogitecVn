...
*@FileName : CarrierJooDBDAOCarrierJooVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierJooDBDAOCarrierJooVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierJooDBDAOCarrierJooVOUSQL(){
		setQuery();
		...
		query.append("FileName : CarrierJooDBDAOCarrierJooVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
