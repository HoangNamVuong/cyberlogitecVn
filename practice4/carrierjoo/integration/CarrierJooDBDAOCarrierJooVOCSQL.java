...
*@FileName : CarrierJooDBDAOCarrierJooVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierJooDBDAOCarrierJooVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierJooDBDAOCarrierJooVOCSQL(){
		setQuery();
		...
		query.append("FileName : CarrierJooDBDAOCarrierJooVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
