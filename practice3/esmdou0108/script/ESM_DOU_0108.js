	...
	function jo_crr_cd_OnCheckClick(comboObj, index, code, formObj, sheetObj) {	
		...
		if(index==0) {          
	        ...
	        if(index != 0) {
				...
				ComOpenWait(true);
				//getXml
				var sXml = sheetObj.GetSearchData("ESM_DOU_0108GS.do",param);
...
//		sheetObjects[1].SetSelectRow(row);
	...
	//	  				ComOpenWait(true);	
		  				sheetObj.DoSearch("ESM_DOU_0108GS.do", sParam1);
	//	  				var sXml = sheetObj.GetSearchData("ESM_DOU_0108GS.do", sParam1);
