...
*@FileName : InvoiceManagementDAOInvoiceDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManagementDAOInvoiceDtlRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InvoiceManagementDAOInvoiceDtlRSQL
	  * </pre>
	  */
	public InvoiceManagementDAOInvoiceDtlRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManagementDAOInvoiceDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
